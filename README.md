...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
 ...
 Semantic HTML uses tags that have specific meaning. When the tag is used correctly anyone can read the code and know what is in between the tags. Ex..<form> <image> or <article>. 
